...
fun EditableExposedDropdownMenuSample(
    ...
    EditableExposedDropdownMenuSampleImpl(modifier)
}

@OptIn(ExperimentalMaterial3Api::class)
@Composable
internal fun EditableExposedDropdownMenuSampleImpl(
    modifier: Modifier = Modifier,
    viewModel: LocationViewModelDefinition = koinViewModel<LocationViewModel>(),
) {
